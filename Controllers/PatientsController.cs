...
namespace WimMed.Controllers
{
  ...
  public class PatientsController : ControllerBase
  {
    ...
    ///<summary>
    ///Search Patients using parameter search text, filter by IdNumber or Name as parameter
    ///</summary>
    ///<param name="searchText" >Text captured from UI or passed by api caller in string format</param>
    ...
    public IActionResult FindPatient(string searchText)
    {
      var patients = dbContext.Patients
        .Where(p => p.IdNumber.Contains(searchText) ||
      ...
      // Return the list of patients that match the search criteria
      return Ok(patients);
