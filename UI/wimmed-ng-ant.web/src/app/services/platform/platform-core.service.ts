...
export class PlatformCoreService {
  ...
  const tabItem = { title: 'Dashboard', module: '/system/home', power: '', isSelect: true };
    return tabItem;
  }
  ...
  subTabItem = new MenuItem();
  subTabItem.label = 'Layout';
  subTabItem.module = '/examples/layout';
  tabItem.children.push(subTabItem);

  subTabItem = new MenuItem();
  subTabItem.label = 'Default Content Layout';
